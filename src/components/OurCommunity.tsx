...
export const OurCommunity = ({
  ...
  const cardData = [
    ...
    },
    {
      ...
      content:
        "Most writers have at some stage been asked to make changes to their manuscript to reflect someone else’s view of the market. At Fableration, we want writers to write the story they want to write, not constrain their creativity.",
      link: "/ourcommunity/1",
      target: "_self",
    },
    {
